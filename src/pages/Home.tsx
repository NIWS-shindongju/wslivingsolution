    ...
    <div className="w-full">
      ...
      <section className="py-14 md:py-20 lg:py-24 bg-white">
        <div className="container mx-auto px-5 md:px-6 lg:px-8">
          ...
          <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-4 -mx-5 px-5 scrollbar-hide md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-8">
            <div className="min-w-[280px] snap-center flex-shrink-0 md:min-w-0 bg-warm-ivory rounded-xl p-5 md:p-8 border-l-4 border-copper hover-lift">
            ...
            <div className="min-w-[280px] snap-center flex-shrink-0 md:min-w-0 bg-warm-ivory rounded-xl p-5 md:p-8 border-l-4 border-copper hover-lift">
              <div className="w-12 h-12 md:w-16 md:h-16 bg-copper/10 rounded-full flex items-center justify-center mb-6">
                <Factory className="text-copper" size={24} />
              </div>
          ...
          <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-4 -mx-5 px-5 scrollbar-hide md:grid md:grid-cols-3 md:gap-8">
            {[
              ...
              <Link key={i} to={product.link} className="min-w-[260px] md:min-w-0 snap-center flex-shrink-0 md:flex-shrink group bg-warm-ivory rounded-xl overflow-hidden hover-lift">
                <div className="h-48 md:h-64 bg-gray-300 flex items-center justify-center text-sm text-gray-600 relative overflow-hidden">
                  [{product.img}]
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
            {[
              ...
              <Link key={index} to={product.link} className="group bg-white rounded-xl overflow-hidden hover-lift">
                <div className="h-36 md:h-64 bg-gray-200 flex items-center justify-center text-xs md:text-sm text-gray-500 p-2 md:p-4 text-center relative overflow-hidden">
                  [{product.image}]
        ...
        <div className="container mx-auto px-5 md:px-6 lg:px-8">
          ...
          <div className="relative max-w-5xl mx-auto">
            <div className="overflow-hidden rounded-2xl">
              <div
                className="relative h-72 md:h-96 lg:h-[500px] bg-gradient-to-br from-charcoal to-dark-slate flex flex-col items-center justify-center p-8 text-center"
                onTouchStart={handleTouchStart}
                onTouchEnd={handleTouchEnd}
              >
                <div className="text-xs md:text-sm text-gray-500 mb-4">[{portfolioSlides[currentSlide].image}]</div>
                ...
                <p className="text-gray-400 text-sm md:text-lg font-light">{portfolioSlides[currentSlide].description}</p>
              </div>
            </div>
