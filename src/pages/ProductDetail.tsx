    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-warm-ivory">
        <div className="text-center px-6">
          ...
          <Link to="/" className="inline-block bg-copper hover:bg-copper-dark text-white px-8 py-3 rounded-lg transition-all">
            홈으로 돌아가기
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="w-full">
      <section className="relative h-screen flex items-center justify-center bg-dark-slate">
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-8">
          <button
            ...
            className="flex items-center text-warm-ivory hover:text-copper mb-8 transition-colors group"
          >
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-light text-white mb-4 leading-tight">
              {product.name}
            </h1>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              <div className="mb-6 rounded-xl overflow-hidden bg-gray-100 aspect-square flex items-center justify-center text-gray-500 text-sm p-8 text-center">
              ...
              <div className="grid grid-cols-4 gap-4">
                {product.galleryImages.slice(0, 4).map((img, i) => (
                  <button
                    ...
                    className={`aspect-square rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center text-xs text-gray-400 p-2 transition-all ${
            ...
            <div>
              <h2 className="font-serif text-3xl font-light text-charcoal mb-6">제품 소개</h2>
      ...
      <section className="py-24 bg-warm-ivory">
        <div className="container mx-auto px-6 lg:px-8">
          <h2 className="font-serif text-4xl font-light text-charcoal mb-12 text-center">제품 사양</h2>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 lg:px-8">
          <h2 className="font-serif text-4xl font-light text-charcoal mb-12 text-center">주요 특징</h2>
      ...
      {relatedProducts.length > 0 && (
        <section className="py-24 bg-warm-ivory">
          <div className="container mx-auto px-6 lg:px-8">
            <h2 className="font-serif text-4xl font-light text-charcoal mb-12 text-center">관련 제품</h2>
